...
if(!(isset($_SERVER['PHP_AUTH_USER'])) && !(isset($_GET["act"])))
{
	include "modules/landing.php";
}
elseif((isset($_GET["act"])) && ($_GET["act"] == "register_user"))
{
	include "modules/user_register.php";
}
elseif((isset($_GET["act"])) && ($_GET["act"] == "reset_password"))
{
	include "modules/user_reset_password.php";
}
else
{
	...
	$acts = array(
		'show_users' => 'resources/show_users.php',
	...
	if(isset($_GET["act"]) && array_key_exists($_GET["act"], $acts))
	{
		include($acts[$_GET["act"]]);
	}
	else
	{
		include('modules/user_main.php');
	}
